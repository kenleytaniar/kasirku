...
<?php 
    $no = 1;
    $data_laporan = mysqli_query($conn,"SELECT * FROM inv WHERE status='selesai' ORDER BY invid DESC");
...
<div class="d-none pt-5 px-5 print-show">
        <div class="text-center mb-5 pt-2">
            ...
            <h2 class="mb-3" style="font-size:40px;">Laporan Penjualan</h2>
        </div>
        <table class="table table-striped table-sm table-bordered dt-responsive nowrap" id="table" width="100%">
<thead>
  <tr>
      ...
      <div class="col-12 py-3 my-3 border-top">
            <div class="row justify-content-end">
                ...
                <div class="col-12 text-left border-bottom">
                  <h2 class="mb-1" style="font-weight:700;">Pendapatan <span class="ml-3">: Rp.<?php echo ribuan($i3['totdpt1']); ?></span></h2>
                  <h2 class="mb-1" style="font-weight:700;">Terjual <span class="ml-3">: <?php echo ribuan($i1['totqty']); ?></span></h2>
