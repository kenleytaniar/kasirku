...
<head>
    ...
    <title>Kasir Swalayan Suka Benar</title>
...
body {
  ...
  padding-top: 40px;
  padding-bottom: 40px;
  background-image: url('assets/images/bglogin1.webp');
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      <img class="mb-4" src="assets/images/logobaru.png" alt="" width="150" height="150">
      <img class="mb-4" src="assets/images/sukabenar.png" alt="" width="150" height="150">
